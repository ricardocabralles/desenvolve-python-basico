...
arqueiro), os pontos de força e os pontos de magia atribuídos 
ao personagem. O programa deve imprimir True se os pontos de 
atributo são consistentes com a classe escolhida, seguindo as 
seguintes regras:

Guerreiro: Força deve ser igual ou superior a 15, Magia deve ser 10 
ou menos.

Mago: Força deve ser 10 ou menos, Magia deve ser igual ou superior
 a 15.
...
consistentes com a classe escolhida. Segue um exemplo de interação
 com seu código no terminal, com entradas de dados destacadas em 
...
personagem=input(("Escolha a classe digitando o numero correspondente (1- guerreiro, 2 - mago ou 3 - arqueiro)"))
...
chave=(((personagem=="1")and( forca>=15) and (magia<=10)) or ((personagem=="2")and( forca<=10) and (magia>=15)) or ((personagem=="3")and( 5<forca<=15) and (5<magia<=15))) 

print("Pontos de atributo consistentes com a classe escolhida: ", chave)